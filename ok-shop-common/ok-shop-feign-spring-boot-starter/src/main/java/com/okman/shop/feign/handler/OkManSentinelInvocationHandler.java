 ...
 */
@Slf4j
public class OkManSentinelInvocationHandler implements InvocationHandler {
	...
	public OkManSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			OkManSentinelInvocationHandler other = (OkManSentinelInvocationHandler) obj;
