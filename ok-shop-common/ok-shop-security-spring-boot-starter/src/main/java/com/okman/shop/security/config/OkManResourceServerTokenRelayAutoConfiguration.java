package com.okman.shop.security.config;
 ...
 *
 * @Author Iverson.Z
 * @Description 功能说明：注入AccessTokenContextRelay 解决feign 传递token 为空问题
...
public class OkManResourceServerTokenRelayAutoConfiguration {
